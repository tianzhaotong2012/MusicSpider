...
define('MAX_FILE_SIZE', 100000000); //100M
// helper functions
// -----------------------------------------------------------------------------
...
class simple_html_dom_node
{
	...
	public $tag_start = 0;
	private $dom = null;
        public $my_node_array = array(); //精简版的节点树
		...
		if (!is_null($this->nodes))
		{
			foreach ($this->nodes as $n)
			{
                                if ($n->tag == "img")
				{
					...
					$ret .= ">";
                                        //$my_node_item1  = array();
                                        //array_push($my_node_item1,"img");
					//array_push($my_node_item1,$n->outertext());
					//array_push($this->my_node_array,$my_node_item1);
                                        //array_push($this->my_node_array,$n->getAttribute("data-echo"));
				...
				$ret .= $this->convert_text($n->text());
					...
					$ret .= ">";
                                ...
                                $my_node_item2  = array();
                                //array_push($my_node_item2,$n->tag);
				//array_push($my_node_item2,$n->text());
				//array_push($this->my_node_array,$my_node_item2);
                                //array_push($this->my_node_array,$this->convert_text($n->text()));
			}
			...
			if ($this->tag == "span")
			{
				$ret .= $this->dom->default_span_text;
                                //$my_node_item3  = array();
                                //array_push($my_node_item3,$this->tag);
				//array_push($my_node_item3,$this->text());
				//array_push($this->my_node_array,$my_node_item3);
				//array_push($this->my_node_array,$this->text());
			}
		...
		switch ($name)
		{
			...
			case 'target_charset':
				return $this->_target_charset;
                        case 'my_node_array':
				return $this->root->my_node_array;
		}
	}
