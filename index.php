	...
	public function get_xiami($sid, $type){
		...
		if (isset($result["data"]["trackList"])){
			...
			if ($type==0){
				...
				$html .= sprintf('<a href="javascript:void(0);" onclick="var song = new Array();song[0]=\'%s\';song[1]=\'%s\',song[2]=\'%s\';song[3]=\'%s\';submit_song(song);">spider</a>',$name,$artist,$track["pic"],$data["src"]);
				$html.= $close.'</div>';
			}
			else {
...
<div id="submit_info">
	...
	<input id="submit_song_name" class="input input-left" name="song_name" type="text" value="" placeholder="song_name" />
	<input id="submit_artist" class="input input-right" name="artist" type="text" value="" placeholder="artist" />
	</br>
	<input id="submit_song_img" class="input input-left" name="song_img" type="text" value="" placeholder="song_img" style="color:red;"/>
	<input id="submit_song_url" class="input input-right" name="song_url" type="text" value="" placeholder="song_url" />
	<input id="submit_song_pinyin" class="input input-left" name="song_pinyin" type="text" value="" placeholder="song_pinyin" />
